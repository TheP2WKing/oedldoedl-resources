...
public class ModItemIngotEffectBase extends ModItemBase {
	public final Potion effect;
	public final boolean isDebuff;

	public ModItemIngotEffectBase(String modid, String name, CreativeTabs tab, Potion effect, boolean isDebuff,
			...
			((EntityLivingBase) entityIn)
					.addPotionEffect(
							new PotionEffect(effect, ResourcesConfig.PROPERTIES.EFFECTS.INGOTS.INGOT_BASE_DURATION,
									ResourcesConfig.PROPERTIES.EFFECTS.INGOTS.INGOT_BASE_AMPLIFIER - 1, false, false));
		}
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		if (ModTooltips.showEffectTip()
			...
			ModTooltips.addPotionEffect(tooltip, effect.getName(), isDebuff,
					ResourcesConfig.PROPERTIES.EFFECTS.INGOTS.INGOT_BASE_AMPLIFIER,
