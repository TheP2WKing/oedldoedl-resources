...
import net.thep2wking.oedldoedlresources.content.block.misc.BlockBaconAgaric;
...
import net.thep2wking.oedldoedlresources.content.block.ore.BlockNiterOre;
...
import net.thep2wking.oedldoedlresources.content.block.ore.BlockSulfurOre;
...
public class ModBlocks {
	...
	public static final Block CATERIUM_ORE = new ModBlockOreBase(OedldoedlResources.MODID, "caterium_ore", OedldoedlResources.TAB, 0, 0, Material.ROCK, SoundType.STONE, MapColor.STONE, 1, ModToolTypes.PICKAXE, 4f, 8f, 0);
	...
	public static final Block SULFUR_ORE = new BlockSulfurOre(OedldoedlResources.MODID, "sulfur_ore", OedldoedlResources.TAB, 0, 1, Material.ROCK, SoundType.STONE, MapColor.STONE, 0, ModToolTypes.PICKAXE, 3f, 3f, 0);
	public static final Block NITER_ORE = new BlockNiterOre(OedldoedlResources.MODID, "niter_ore", OedldoedlResources.TAB, 0, 1, Material.ROCK, SoundType.STONE, MapColor.STONE, 0, ModToolTypes.PICKAXE, 3f, 3f, 0);
	...
	public static final Block CATERIUM = new ModBlockBase(OedldoedlResources.MODID, "caterium_block", OedldoedlResources.TAB, Material.IRON, SoundType.METAL, MapColor.YELLOW, 2, ModToolTypes.PICKAXE, 8f, 16f, 0).setBeaconBase();
	...
	public static final Block BACON_AGARIC = new BlockBaconAgaric(OedldoedlResources.MODID, "bacon_agaric", OedldoedlResources.TAB, ModPlantAABB.BUSH, true, true, Material.PLANTS, SoundType.PLANT, MapColor.PINK, 0, ModToolTypes.NO_TOOL, 0f, 0.0f, 0);
}	