...
public class DrunkiumIngotItem extends ModItemEffectIngotBase
{
    public Effect effect2;
    public Effect effect3;
    public Effect effect4;

	public DrunkiumIngotItem(Rarity rarity, boolean hasEffect, boolean fireImmunity, Effect effect, Effect effect2, Effect effect3, Effect effect4, 
	...
	{
		if (ResourcesConfig.ingot_effects_enabled.get() && ResourcesConfig.effects_enabled.get())
		{
			((LivingEntity) entityIn).addPotionEffect(new EffectInstance(effect, ResourcesConfig.ingot_base_duration.get(), 0, false, false));
			((LivingEntity) entityIn).addPotionEffect(new EffectInstance(effect2, 10, ResourcesConfig.ingot_base_amplifier.get() - 1 + 2, false, false));
			((LivingEntity) entityIn).addPotionEffect(new EffectInstance(effect3, ResourcesConfig.ingot_base_duration.get(), 0, false, false));
			((LivingEntity) entityIn).addPotionEffect(new EffectInstance(effect4, ResourcesConfig.ingot_base_duration.get(), ResourcesConfig.ingot_base_amplifier.get() - 1 + 1, false, false));
		}
	}
	...
	{
	    return ResourcesConfig.ingot_base_amplifier.get() + 2;
	}
	...
	{
	    return ResourcesConfig.ingot_base_amplifier.get() + 1;
	}
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) 
    {
		...
		if (Screen.hasControlDown() && CoreConfig.effects_tooltip.get() && ResourcesConfig.ingot_effects_enabled.get() && ResourcesConfig.effects_enabled.get())
		{
			...
			tooltip.add((new StringTextComponent("- ").mergeStyle(CoreConfig.effects_formatting.get()).mergeStyle(TextFormatting.ITALIC).appendSibling(new TranslationTextComponent(effect.getName())
					...
					+ ResourcesConfig.ingot_base_duration.get() / 20 + " sec)")).mergeStyle(TextFormatting.ITALIC))));
		...
		else if (CoreConfig.effects_tooltip.get() && CoreConfig.effects_tooltip_key.get() && ResourcesConfig.ingot_effects_enabled.get() && ResourcesConfig.effects_enabled.get())
		{
