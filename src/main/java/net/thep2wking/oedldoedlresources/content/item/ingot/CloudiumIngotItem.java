...
public class CloudiumIngotItem extends ModItemEffectIngotBase
{
    public CloudiumIngotItem(Rarity rarity, boolean hasEffect, boolean fireImmunity, Effect effect, boolean isDebuff, TipLines lines, boolean hasAnnotation, Properties properties) 
    {
