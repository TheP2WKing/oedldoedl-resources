...
public class ItemCloudiumNugget extends ModItemIngotEffectBase {
	public ItemCloudiumNugget(String modid, String name, CreativeTabs tab, Potion effect, boolean isDebuff, EnumRarity rarity, boolean hasEffect, int tooltipLines, int annotationLines) {
