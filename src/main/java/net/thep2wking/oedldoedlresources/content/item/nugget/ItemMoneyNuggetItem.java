...
public class ItemMoneyNuggetItem extends ModItemBase {
	public ItemMoneyNuggetItem(String modid, String name, CreativeTabs tab, EnumRarity rarity, boolean hasEffect,
