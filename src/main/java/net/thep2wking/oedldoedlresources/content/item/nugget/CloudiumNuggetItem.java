...
public class CloudiumNuggetItem extends ModItemEffectNuggetBase
{
    public CloudiumNuggetItem(Rarity rarity, boolean hasEffect, boolean fireImmunity, Effect effect, boolean isDebuff, TipLines lines, boolean hasAnnotation, Properties properties) 
    {
