...
public class ItemDrunkiumNugget extends ModItemIngotEffectBase {
	public final Potion effect2;
	public final Potion effect3;
	public final Potion effect4;

	public ItemDrunkiumNugget(String modid, String name, CreativeTabs tab, Potion effect, Potion effect2, Potion effect3,
	...
	public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
		if (entityIn instanceof EntityLivingBase && ResourcesConfig.PROPERTIES.EFFECTS.EFFECTS_EBALED
			...
			((EntityLivingBase) entityIn).addPotionEffect(
					new PotionEffect(effect, ResourcesConfig.PROPERTIES.EFFECTS.NUGGETS.NUGGET_BASE_DURATION, 0, false,
							false));
			((EntityLivingBase) entityIn).addPotionEffect(
					new PotionEffect(effect2, 10,
							ResourcesConfig.PROPERTIES.EFFECTS.NUGGETS.NUGGET_BASE_AMPLIFIER - 1 + 2, false, false));
			((EntityLivingBase) entityIn).addPotionEffect(
					new PotionEffect(effect3, ResourcesConfig.PROPERTIES.EFFECTS.NUGGETS.NUGGET_BASE_DURATION, 0, false,
							false));
			((EntityLivingBase) entityIn).addPotionEffect(
					new PotionEffect(effect4, ResourcesConfig.PROPERTIES.EFFECTS.NUGGETS.NUGGET_BASE_DURATION,
