...
public class ItemBedrockiumIngot extends ModItemIngotEffectBase {
	public final Potion effect2;

	public ItemBedrockiumIngot(String modid, String name, CreativeTabs tab, Potion effect, Potion effect2,
	...
	public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
		if (entityIn instanceof EntityLivingBase && ResourcesConfig.PROPERTIES.EFFECTS.EFFECTS_EBALED
			...
			((EntityLivingBase) entityIn).addPotionEffect(new PotionEffect(effect, 10,
					ResourcesConfig.PROPERTIES.EFFECTS.INGOTS.INGOT_BASE_AMPLIFIER - 1 + 4, false, false));
	...
	public int getEffect() {
		return ResourcesConfig.PROPERTIES.EFFECTS.INGOTS.INGOT_BASE_AMPLIFIER + 4;
	}
