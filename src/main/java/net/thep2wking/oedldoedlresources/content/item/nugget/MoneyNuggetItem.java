...
public class MoneyNuggetItem extends ModItemBase
{
    public MoneyNuggetItem(Rarity rarity, boolean hasEffect, boolean fireImmunity, TipLines lines, boolean hasAnnotation, Properties properties) 
    {
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) 
    {
		...
		{ 
			...
			{
				worldIn.playSound(null, playerIn.getPosition(), ModSounds.MONEY.get(), SoundCategory.BLOCKS, 0.2f, 1f);
			}
