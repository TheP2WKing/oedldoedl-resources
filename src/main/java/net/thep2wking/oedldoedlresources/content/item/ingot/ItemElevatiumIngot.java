...
public class ItemElevatiumIngot extends ModItemIngotEffectBase {
	public ItemElevatiumIngot(String modid, String name, CreativeTabs tab, Potion effect, boolean isDebuff,
	...
	public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
		if (entityIn instanceof EntityLivingBase && ResourcesConfig.PROPERTIES.EFFECTS.EFFECTS_EBALED
			...
			((EntityLivingBase) entityIn).addPotionEffect(new PotionEffect(effect, 10,
					ResourcesConfig.PROPERTIES.EFFECTS.INGOTS.INGOT_BASE_AMPLIFIER - 1 + 9, false, false));
		}
	}

	public int getEffect() {
		return ResourcesConfig.PROPERTIES.EFFECTS.INGOTS.INGOT_BASE_AMPLIFIER + 9;
	}
