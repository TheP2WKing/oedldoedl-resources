...
public class ItemSadistiumIngot extends ModItemIngotEffectBase {
	public final Potion effect2;
	public final Potion effect3;

	public ItemSadistiumIngot(String modid, String name, CreativeTabs tab, Potion effect, Potion effect2,
	...
	public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
		if (entityIn instanceof EntityLivingBase && ResourcesConfig.PROPERTIES.EFFECTS.EFFECTS_EBALED
			...
			((EntityLivingBase) entityIn).addPotionEffect(
					new PotionEffect(effect, ResourcesConfig.PROPERTIES.EFFECTS.INGOTS.INGOT_BASE_DURATION,
							ResourcesConfig.PROPERTIES.EFFECTS.INGOTS.INGOT_BASE_AMPLIFIER - 1 + 2, false, false));
			((EntityLivingBase) entityIn).addPotionEffect(
					new PotionEffect(effect2, ResourcesConfig.PROPERTIES.EFFECTS.INGOTS.INGOT_BASE_DURATION,
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		if (ModTooltips.showEffectTip() && ResourcesConfig.PROPERTIES.EFFECTS.INGOTS.INGOT_EFFECTS
			...
			ModTooltips.addPotionEffect(tooltip, effect.getName(), isDebuff, getEffect(), ResourcesConfig.PROPERTIES.EFFECTS.INGOTS.INGOT_BASE_DURATION);
			ModTooltips.addPotionEffect(tooltip, effect2.getName(), isDebuff, getEffect2(), ResourcesConfig.PROPERTIES.EFFECTS.INGOTS.INGOT_BASE_DURATION);
