...
public class ItemBlockDrunkium extends ModItemBlockEffectBase {
	public final Potion effect2;
	public final Potion effect3;
	public final Potion effect4;

	public ItemBlockDrunkium(Block block, Potion effect, Potion effect2, Potion effect3, Potion effect4,
	...
	public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
		if (entityIn instanceof EntityLivingBase && ResourcesConfig.PROPERTIES.EFFECTS.EFFECTS_EBALED
			...
			((EntityLivingBase) entityIn).addPotionEffect(
					new PotionEffect(effect, ResourcesConfig.PROPERTIES.EFFECTS.BLOCKS.BLOCK_BASE_DURATION, 0, false,
							false));
			((EntityLivingBase) entityIn).addPotionEffect(
					new PotionEffect(effect2, 10,
							ResourcesConfig.PROPERTIES.EFFECTS.BLOCKS.BLOCK_BASE_AMPLIFIER - 1 + 2, false, false));
			((EntityLivingBase) entityIn).addPotionEffect(
					new PotionEffect(effect3, ResourcesConfig.PROPERTIES.EFFECTS.BLOCKS.BLOCK_BASE_DURATION, 0, false,
							false));
			((EntityLivingBase) entityIn).addPotionEffect(
					new PotionEffect(effect4, ResourcesConfig.PROPERTIES.EFFECTS.BLOCKS.BLOCK_BASE_DURATION,
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		if (ModTooltips.showEffectTip() && ResourcesConfig.PROPERTIES.EFFECTS.BLOCKS.BLOCK_WALKING_EFFECTS
			...
			ModTooltips.addPotionEffect(tooltip, effect.getName(), isDebuff, getEffect5(),
					ResourcesConfig.PROPERTIES.EFFECTS.BLOCKS.BLOCK_WALKING_BASE_DURATION);
			ModTooltips.addPotionEffect(tooltip, effect2.getName(), isDebuff, getEffect6(), 20);
			ModTooltips.addPotionEffect(tooltip, effect3.getName(), isDebuff, getEffect7(),
					ResourcesConfig.PROPERTIES.EFFECTS.BLOCKS.BLOCK_WALKING_BASE_DURATION);
			ModTooltips.addPotionEffect(tooltip, effect4.getName(), isDebuff, getEffect8(),
					ResourcesConfig.PROPERTIES.EFFECTS.BLOCKS.BLOCK_WALKING_BASE_DURATION);
