...
public class ItemBlockMoney extends ModItemBlockBase {
	public ItemBlockMoney(Block block, EnumRarity rarity, boolean hasEffect, int tooltipLines, int annotationLines) {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		...
		if (ResourcesConfig.CONTENT.MONEY_SOUND) {
			if (handIn == EnumHand.MAIN_HAND) {
				worldIn.playSound(null, playerIn.getPosition(), ModSounds.MONEY, SoundCategory.BLOCKS, 1f, 1f);
			}
