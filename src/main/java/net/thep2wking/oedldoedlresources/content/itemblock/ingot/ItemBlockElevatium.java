...
public class ItemBlockElevatium extends ModItemBlockEffectBase {
	public ItemBlockElevatium(Block block, Potion effect, boolean isDebuff, EnumRarity rarity, boolean hasEffect,
	...
	public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
		if (entityIn instanceof EntityLivingBase && ResourcesConfig.PROPERTIES.EFFECTS.EFFECTS_EBALED
			...
			((EntityLivingBase) entityIn).addPotionEffect(new PotionEffect(effect, 10,
					ResourcesConfig.PROPERTIES.EFFECTS.BLOCKS.BLOCK_BASE_AMPLIFIER - 1 + 13, false, false));
		}
	}

	public int getEffect() {
		return ResourcesConfig.PROPERTIES.EFFECTS.BLOCKS.BLOCK_BASE_AMPLIFIER + 13;
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		if (ModTooltips.showEffectTip() && ResourcesConfig.PROPERTIES.EFFECTS.BLOCKS.BLOCK_WALKING_EFFECTS
			...
			ModTooltips.addPotionEffect(tooltip, effect.getName(), isDebuff, getEffect2(), 20);
