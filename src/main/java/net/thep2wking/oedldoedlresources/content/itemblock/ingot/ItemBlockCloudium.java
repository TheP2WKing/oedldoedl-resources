...
public class ItemBlockCloudium extends ModItemBlockEffectBase {
	public ItemBlockCloudium(Block block, Potion effect, boolean isDebuff, EnumRarity rarity, boolean hasEffect,
