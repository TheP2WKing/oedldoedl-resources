...
public class ElevatiumBlock extends ModBlockEffectBase implements TOPInfoProvider
{
	public ElevatiumBlock(SoundType sound, int harvestLevel, float hardness, float resistance, ToolType toolType, Effect effect, boolean isDebuff, int lightLevel, Properties properties) 
	{
	...
	public void onEntityWalk(World worldIn, BlockPos pos, Entity entityIn) 
	{
		...
		{
			((LivingEntity) entityIn).addPotionEffect(new EffectInstance(effect, 10, ResourcesConfig.block_walking_base_amplifier.get() - 1 + 17, false, false));
		}
	}
