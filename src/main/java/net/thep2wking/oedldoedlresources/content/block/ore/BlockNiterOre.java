...
public class BlockNiterOre extends ModBlockOreBase {
	public BlockNiterOre(String modid, String name, CreativeTabs tab, int minXp, int maxXp, Material material,
