...
public class ElevatiumBlockItem extends ModBlockItemEffectBase
{
	public ElevatiumBlockItem(Block blockIn, Rarity rarity, boolean hasEffect, boolean fireImmunity, Effect effect, boolean isDebuff, TipLines lines, boolean hasAnnotation, Properties properties) 
    {
	...
	public void inventoryTick(ItemStack stack, World worldIn, Entity entityIn, int ambient, boolean particles) 
	{
		...
		{
			((LivingEntity) entityIn).addPotionEffect(new EffectInstance(effect, 10, ResourcesConfig.block_base_amplifier.get() - 1 + 13, false, false));
		}
	}
	
	public int getEffect()
	{
		return ResourcesConfig.block_base_amplifier.get() + 13;
	}
	
	public int getEffect2()
	{
	    return ResourcesConfig.block_walking_base_amplifier.get() + 17;
	}
