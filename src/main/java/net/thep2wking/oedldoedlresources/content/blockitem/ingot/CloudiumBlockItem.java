...
public class CloudiumBlockItem extends ModBlockItemEffectBase
{
	public CloudiumBlockItem(Block blockIn, Rarity rarity, boolean hasEffect, boolean fireImmunity, Effect effect, boolean isDebuff, TipLines lines, boolean hasAnnotation, Properties properties) 
    {
