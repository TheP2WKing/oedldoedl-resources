...
public class MoneyBlockItem extends ModBlockItemBase
{
    public MoneyBlockItem(Block blockIn, Rarity rarity, boolean hasEffect, boolean fireImmunity, TipLines lines, boolean hasAnnotation, Properties properties) 
    {
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) 
    {
		...
		{     
			...
			{
				worldIn.playSound(null, playerIn.getPosition(), ModSounds.MONEY.get(), SoundCategory.BLOCKS, 1, 1);
			}
