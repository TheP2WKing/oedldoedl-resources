package net.thep2wking.oedldoedlresources.content.blockitem.ingot;
...
public class DrunkiumBlockItem extends ModBlockItemEffectBase
{
	public Effect effect2;
    public Effect effect3;
    public Effect effect4;
    
    public DrunkiumBlockItem(Block blockIn, Rarity rarity, boolean hasEffect, boolean fireImmunity, Effect effect, Effect effect2, Effect effect3, Effect effect4, boolean isDebuff, TipLines lines, boolean hasAnnotation, Properties properties) 
    {
		super(blockIn, rarity, hasEffect, fireImmunity, effect, isDebuff, lines, hasAnnotation, properties);
	...
	public void inventoryTick(ItemStack stack, World worldIn, Entity entityIn, int ambient, boolean particles) 
	{
		...
		{
			((LivingEntity) entityIn).addPotionEffect(new EffectInstance(effect, ResourcesConfig.block_base_duration.get(), 0, false, false));
			((LivingEntity) entityIn).addPotionEffect(new EffectInstance(effect2, 10, ResourcesConfig.block_base_amplifier.get() - 1 + 2, false, false));
			((LivingEntity) entityIn).addPotionEffect(new EffectInstance(effect3, ResourcesConfig.block_base_duration.get(), 0, false, false));
			((LivingEntity) entityIn).addPotionEffect(new EffectInstance(effect4, ResourcesConfig.block_base_duration.get(), ResourcesConfig.block_base_amplifier.get() - 1 + 1, false, false));
		}
	}
	...
	{
	    return ResourcesConfig.block_base_amplifier.get() + 2;
	}
	...
	{
	    return ResourcesConfig.block_base_amplifier.get() + 1;
	}
	...
	public int getEffect7()
	{
	    return 1;
	}
	
	public int getEffect8()
	{
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) 
    {
		...
		{	
			...
			tooltip.add((new StringTextComponent("- ").mergeStyle(CoreConfig.effects_formatting.get()).mergeStyle(TextFormatting.ITALIC).appendSibling(new TranslationTextComponent(effect.getName())
					.mergeStyle(CoreConfig.effects_formatting.get()).mergeStyle(TextFormatting.ITALIC)
					.appendSibling(new StringTextComponent(" " + effectColor() + TextFormatting.ITALIC + "("+ getEffect5() + ") (" 
					+ ResourcesConfig.block_walking_base_duration.get() / 20 + " sec)")).mergeStyle(TextFormatting.ITALIC))));
			tooltip.add((new StringTextComponent("- ").mergeStyle(CoreConfig.effects_formatting.get()).mergeStyle(TextFormatting.ITALIC).appendSibling(new TranslationTextComponent(effect2.getName())
					.mergeStyle(CoreConfig.effects_formatting.get()).mergeStyle(TextFormatting.ITALIC)
					.appendSibling(new StringTextComponent(" " + effectColor() + TextFormatting.ITALIC + "("+ getEffect6() + ") (" 
					+ 1 + " sec)")).mergeStyle(TextFormatting.ITALIC))));
			tooltip.add((new StringTextComponent("- ").mergeStyle(CoreConfig.effects_formatting.get()).mergeStyle(TextFormatting.ITALIC).appendSibling(new TranslationTextComponent(effect3.getName())
					.mergeStyle(CoreConfig.effects_formatting.get()).mergeStyle(TextFormatting.ITALIC)
					.appendSibling(new StringTextComponent(" " + effectColor() + TextFormatting.ITALIC + "("+ getEffect7() + ") (" 
					+ ResourcesConfig.block_walking_base_duration.get() / 20 + " sec)")).mergeStyle(TextFormatting.ITALIC))));
			tooltip.add((new StringTextComponent("- ").mergeStyle(CoreConfig.effects_formatting.get()).mergeStyle(TextFormatting.ITALIC).appendSibling(new TranslationTextComponent(effect4.getName())
					.mergeStyle(CoreConfig.effects_formatting.get()).mergeStyle(TextFormatting.ITALIC)
					.appendSibling(new StringTextComponent(" " + effectColor() + TextFormatting.ITALIC + "("+ getEffect8() + ") (" 
					+ ResourcesConfig.block_walking_base_duration.get() / 20 + " sec)")).mergeStyle(TextFormatting.ITALIC))));
		}
