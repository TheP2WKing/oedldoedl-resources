package com.thep2wking.oedldoedl.resources.items.misc;
...
public class ItemBalancedClay extends Item implements IHasModel
{
	public ItemBalancedClay(String name) 
	{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.balanced_clay.tip"),
  			});
  		}
  		...
  		if (CoreConfig.GENEREL.tooltips.originInformation) 
  		{
  			...
  			{
  				TextFormatting.DARK_AQUA+""+TextFormatting.ITALIC+I18n.format("item.oedldoedl.stoneblock.origin.tip"),
  			});
  		}
	}
}