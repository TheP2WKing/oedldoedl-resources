...
public class ItemBaseNugget extends Item implements IHasModel
{
	public ItemBaseNugget(String name) 
	{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.base_nugget.tip"),
  			});
  		}
	}
}