...
public class ItemArgentoriumGem extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	...
	public void registerModels()
	{
		if (ResourcesConfig.GENEREL.cclProperties)
		{
        	...
        	IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.getObject(argentorium_gem));
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.argentorium_gem.tip"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.argentorium_gem.tip2"),
  			});
  		}
