...
public class ItemPumariumElement extends Item implements IHasModel
{
	public ItemPumariumElement(String name) 
	{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.pumarium_element.tip"),
  			});
  		}
	}
}