...
public class ItemInderiumGem extends Item implements IHasModel
{
	public ItemInderiumGem(String name) 
	{
    ...
    public void onUpdate(ItemStack itemstack, World world, Entity entity, int i, boolean flag)
    {
  		...
  		{	
  	        ((EntityLivingBase) entity).addPotionEffect(new PotionEffect(MobEffects.SLOWNESS, 200, ResourcesConfig.RESOURCES.misc.developerGems.slownessAmplifier - 1, false, false));
  		}
    }
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.inderium_gem.tip"),
  			});
  		}
  		...
  		if (CoreConfig.GENEREL.tooltips.potionInformation && ResourcesConfig.GENEREL.itemsGiveEffects && ResourcesConfig.RESOURCES.misc.developerGems.effectsEnabled) 
  		{
  			TooltipControlEffectInfo.addTooltipText(tooltip, new String[] 
  			{
  				...
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.format("item.oedldoedl.inderium_gem.effects.tip")+TextFormatting.RED+""+TextFormatting.ITALIC+" ("+ResourcesConfig.RESOURCES.misc.developerGems.slownessAmplifier+") "+TextFormatting.YELLOW+""+TextFormatting.ITALIC+"(10 sec)",
  			});
  		}
	}
}