...
public class ItemNetherNugget extends Item implements IHasModel
{
	public ItemNetherNugget(String name) 
	{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.nether_nugget.tip"),
  			});
  		}
	}
}