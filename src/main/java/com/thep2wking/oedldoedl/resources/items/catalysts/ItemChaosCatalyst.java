...
public class ItemChaosCatalyst extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemChaosCatalyst(String name) 
	{
	...
	public void registerModels()
	{
		...
		{
			ModelResourceLocation chaos_catalyst = new ModelResourceLocation("oedldoedlresources:chaos_catalyst");
			ModelLoader.registerItemVariants(this, chaos_catalyst);
			IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.getObject(chaos_catalyst));
			ModelRegistryHelper.register(chaos_catalyst, wrappedModel);
			ModelLoader.setCustomMeshDefinition(this, stack -> chaos_catalyst);
		}
		else
		{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.chaos_catalyst.tip"),
  			});
  		}
