...
public class ItemBedrockiumNugget extends Item implements IHasModel
{
	public ItemBedrockiumNugget(String name) 
	{
    ...
    public void onUpdate(ItemStack itemstack, World world, Entity entity, int i, boolean flag)
    {
  		...
  		{
  			((EntityLivingBase) entity).addPotionEffect(new PotionEffect(MobEffects.SLOWNESS, 10, ResourcesConfig.RESOURCES.metals.bedrockium.slownessAmplifierNugget - 1, false, false));
  			((EntityLivingBase) entity).addPotionEffect(new PotionEffect(MobEffects.HUNGER, 100, ResourcesConfig.RESOURCES.metals.bedrockium.hungerAmplifierNugget - 1, false, false));
  		}
    }
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.bedrockium_nugget.tip"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.bedrockium_nugget.tip2"),
  			});
  		}
  		...
  		if (CoreConfig.GENEREL.tooltips.potionInformation && ResourcesConfig.GENEREL.itemsGiveEffects && ResourcesConfig.RESOURCES.metals.bedrockium.effectsEnabled) 
  		{
  			TooltipControlEffectInfo.addTooltipText(tooltip, new String[] 
  			{
  				...
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.format("item.oedldoedl.bedrockium_nugget.effects.tip")+TextFormatting.RED+""+TextFormatting.ITALIC+" ("+ResourcesConfig.RESOURCES.metals.bedrockium.slownessAmplifierNugget+") "+TextFormatting.YELLOW+""+TextFormatting.ITALIC+"(1 sec)",
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.format("item.oedldoedl.bedrockium_nugget.effects.tip2")+TextFormatting.RED+""+TextFormatting.ITALIC+" ("+ResourcesConfig.RESOURCES.metals.bedrockium.hungerAmplifierNugget+") "+TextFormatting.YELLOW+""+TextFormatting.ITALIC+"(5 sec)",
  			});
  		}
