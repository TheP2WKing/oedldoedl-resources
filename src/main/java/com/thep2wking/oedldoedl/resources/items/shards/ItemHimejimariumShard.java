...
public class ItemHimejimariumShard extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemHimejimariumShard(String name) 
	{
	...
	public void registerModels()
	{
		...
		{
	        ModelResourceLocation himejimarium_shard = new ModelResourceLocation("oedldoedlresources:himejimarium_shard");
	        ModelLoader.registerItemVariants(this, himejimarium_shard);
	        IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.getObject(himejimarium_shard));
	        ModelRegistryHelper.register(himejimarium_shard, wrappedModel);
	        ModelLoader.setCustomMeshDefinition(this, stack -> himejimarium_shard);
		}
		else
		{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.himejimarium_shard.tip"),
  			});
  		}
