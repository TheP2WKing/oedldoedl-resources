...
public class ItemInfinityStar extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	...
	public void registerModels()
	{
        ...
        IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.getObject(infinity_star));
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.infinity_star.tip"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.infinity_star.tip2"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.infinity_star.tip3"),
  			});
  		}
	}
}