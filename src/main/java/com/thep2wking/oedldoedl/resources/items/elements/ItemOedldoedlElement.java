...
public class ItemOedldoedlElement extends Item implements IHasModel
{
	public ItemOedldoedlElement(String name) 
	{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.oedldoedl_element.tip"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.oedldoedl_element.tip2"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.oedldoedl_element.tip3"),
  			});
  		}
	}
}