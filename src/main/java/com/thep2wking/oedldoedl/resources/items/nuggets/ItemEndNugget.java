...
public class ItemEndNugget extends Item implements IHasModel
{
	public ItemEndNugget(String name) 
	{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.end_nugget.tip"),
  			});
  		}
	}
}