package com.thep2wking.oedldoedl.resources.items.dusts;
...
public class ItemOedldoedlDust extends Item implements IHasModel
{
	public ItemOedldoedlDust(String name)
	{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced)
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation)
  		{
  			...
  			{
				TextFormatting.GREEN+I18n.format("item.oedldoedl.oedldoedl_dust.tip"),
				TextFormatting.GREEN+I18n.format("item.oedldoedl.oedldoedl_dust.tip2"),
				TextFormatting.GREEN+I18n.format("item.oedldoedl.oedldoedl_dust.tip3"),
  			});
  		}
	}
}