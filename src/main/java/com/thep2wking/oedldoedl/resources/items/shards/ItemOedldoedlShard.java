...
public class ItemOedldoedlShard extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemOedldoedlShard(String name) 
	{
	...
	public void registerModels()
	{
		...
		{
	        ModelResourceLocation oedldoedl_shard = new ModelResourceLocation("oedldoedlresources:oedldoedl_shard");
	        ModelLoader.registerItemVariants(this, oedldoedl_shard);
	        IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.getObject(oedldoedl_shard));
	        ModelRegistryHelper.register(oedldoedl_shard, wrappedModel);
	        ModelLoader.setCustomMeshDefinition(this, stack -> oedldoedl_shard);
		}
		else
		{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.oedldoedl_shard.tip"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.oedldoedl_shard.tip2"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.oedldoedl_shard.tip3"),
  			});
  		}
	}
}