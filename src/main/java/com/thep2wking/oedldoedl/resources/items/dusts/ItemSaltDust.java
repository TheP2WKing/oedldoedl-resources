...
public class ItemSaltDust extends Item implements IHasModel
{
	public ItemSaltDust(String name)
	{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced)
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation)
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.salt_dust.tip"),
  			});
  		}
  		...
  		if (CoreConfig.GENEREL.tooltips.originInformation) 
  		{
  			...
  			{
  				TextFormatting.DARK_AQUA+""+TextFormatting.ITALIC+I18n.format("item.oedldoedl.mekanism.origin.tip"),
  			});
  		}
	}
}