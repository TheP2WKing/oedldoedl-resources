...
public class ItemBaseFragment extends Item implements IHasModel
{
	public ItemBaseFragment(String name)
	{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced)
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation)
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.base_fragment.tip"),
  			});
  		}
	}
}