...
public class ItemQuartariumIngot extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	...
	public void registerModels()
	{
		if (ResourcesConfig.GENEREL.cclProperties)
		{
			...
			IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.getObject(quartarium_ingot));
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			TooltipShiftInfo.addTooltipText(tooltip, new String[] 
  			{
  				...
  				TextFormatting.BLUE+I18n.format("item.oedldoedl.quartarium_ingot.tip"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.quartarium_ingot.tip2"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.quartarium_ingot.tip3"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.quartarium_ingot.tip4"),
  			});
  		}
