package com.thep2wking.oedldoedl.resources.items.fragments;
...
public class ItemKlaarsiumFragment extends Item implements IHasModel
{
	public ItemKlaarsiumFragment(String name) 
	{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.klaarsium_fragment.tip"),
  			});
  		}
	}
}