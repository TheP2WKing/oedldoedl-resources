...
public class ItemToujouriumShard extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemToujouriumShard(String name) 
	{
	...
	public void registerModels()
	{
		...
		{
        	ModelResourceLocation toujourium_shard = new ModelResourceLocation("oedldoedlresources:toujourium_shard");
	        ModelLoader.registerItemVariants(this, toujourium_shard);
	        IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.getObject(toujourium_shard));
	        ModelRegistryHelper.register(toujourium_shard, wrappedModel);
	        ModelLoader.setCustomMeshDefinition(this, stack -> toujourium_shard);
		}
		else
		{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.toujourium_shard.tip"),
  			});
  		}
