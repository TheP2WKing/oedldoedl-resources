...
public class ItemQuartariumShard extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemQuartariumShard(String name) 
	{
	...
	public void registerModels()
	{
		...
		{
	        ModelResourceLocation quartarium_shard = new ModelResourceLocation("oedldoedlresources:quartarium_shard");
	        ModelLoader.registerItemVariants(this, quartarium_shard);
	        IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.getObject(quartarium_shard));
	        ModelRegistryHelper.register(quartarium_shard, wrappedModel);
	        ModelLoader.setCustomMeshDefinition(this, stack -> quartarium_shard);
		}
		else
		{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.quartarium_shard.tip"),
  			});
  		}
