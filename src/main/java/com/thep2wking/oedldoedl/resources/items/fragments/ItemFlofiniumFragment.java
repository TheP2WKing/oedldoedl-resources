...
public class ItemFlofiniumFragment extends Item implements IHasModel
{
	public ItemFlofiniumFragment(String name) 
	{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.flofinium_fragment.tip"),
  			});
  		}
	}
}