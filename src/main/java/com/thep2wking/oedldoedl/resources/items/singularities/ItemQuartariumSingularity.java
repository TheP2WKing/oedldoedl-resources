...
public class ItemQuartariumSingularity extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	...
	public void registerModels()
	{
		if (ResourcesConfig.GENEREL.cclProperties)
		{
			...
			IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.getObject(quartarium_singularity));
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.quartarium_singularity.tip"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.quartarium_singularity.tip2"),
  			});
  		}
	}
}