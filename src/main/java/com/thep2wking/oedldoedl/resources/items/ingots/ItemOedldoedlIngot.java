...
public class ItemOedldoedlIngot extends Item implements IHasModel
{
	public ItemOedldoedlIngot(String name) 
	{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.oedldoedl_ingot.tip"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.oedldoedl_ingot.tip2"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.oedldoedl_ingot.tip3"),
  			});
  		}
