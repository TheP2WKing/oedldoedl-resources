...
public class ItemLaarsiumGem extends Item implements IHasModel
{
	public ItemLaarsiumGem(String name) 
	{
    ...
    public void onUpdate(ItemStack itemstack, World world, Entity entity, int i, boolean flag)
    {
  		...
  		{	
  	        ((EntityLivingBase) entity).addPotionEffect(new PotionEffect(MobEffects.LUCK, 200, ResourcesConfig.RESOURCES.misc.developerGems.luckAmplifier - 1, false, false));
  		}
    }
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.laarsium_gem.tip"),
  			});
  		}
  		...
  		if (CoreConfig.GENEREL.tooltips.potionInformation && ResourcesConfig.GENEREL.itemsGiveEffects && ResourcesConfig.RESOURCES.misc.developerGems.effectsEnabled) 
  		{
  			TooltipControlEffectInfo.addTooltipText(tooltip, new String[] 
  			{
  				...
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.format("item.oedldoedl.laarsium_gem.effects.tip")+TextFormatting.RED+""+TextFormatting.ITALIC+" ("+ResourcesConfig.RESOURCES.misc.developerGems.luckAmplifier+") "+TextFormatting.YELLOW+""+TextFormatting.ITALIC+"(10 sec)",
  			});
  		}
	}
}