...
public class ItemArgentoriumShard extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemArgentoriumShard(String name) 
	{
	...
	public void registerModels()
	{
		...
		{
	        ModelResourceLocation argentorium_shard = new ModelResourceLocation("oedldoedlresources:argentorium_shard");
	        ModelLoader.registerItemVariants(this, argentorium_shard);
	        IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.getObject(argentorium_shard));
	        ModelRegistryHelper.register(argentorium_shard, wrappedModel);
	        ModelLoader.setCustomMeshDefinition(this, stack -> argentorium_shard);
		}
		else
		{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.argentorium_shard.tip"),
  			});
  		}
