...
public class ItemInfinityShard extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemInfinityShard(String name) 
	{
	...
	public void registerModels()
	{
		...
		{
	        ModelResourceLocation infinity_shard = new ModelResourceLocation("oedldoedlresources:infinity_shard");
	        ModelLoader.registerItemVariants(this, infinity_shard);
	        IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.getObject(infinity_shard));
	        ModelRegistryHelper.register(infinity_shard, wrappedModel);
	        ModelLoader.setCustomMeshDefinition(this, stack -> infinity_shard);
		}
		else
		{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.infinity_shard.tip"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.infinity_shard.tip2"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.infinity_shard.tip3"),
  			});
  		}
	}
}