...
public class ItemOedldoedlFragment extends Item implements IHasModel
{
	public ItemOedldoedlFragment(String name) 
	{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.oedldoedl_fragment.tip"),
  			});
  		}
	}
}