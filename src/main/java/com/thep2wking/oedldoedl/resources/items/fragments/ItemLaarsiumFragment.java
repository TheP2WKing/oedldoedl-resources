...
public class ItemLaarsiumFragment extends Item implements IHasModel
{
	public ItemLaarsiumFragment(String name) 
	{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.laarsium_fragment.tip"),
  			});
  		}
	}
}