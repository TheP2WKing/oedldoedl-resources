...
public class BlockBedrockium extends Block implements IHasModel, TOPInfoProvider
{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.bedrockium_block.tip"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.bedrockium_block.tip2"),
  			});
  		}
    ...
    public void addProbeInfo(ProbeMode mode, IProbeInfo probeInfo, EntityPlayer player, World world, IBlockState blockState, IProbeHitData data) 
    {
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			.text(TextFormatting.GRAY+"Now it is your problem...");
  		}
    }
}