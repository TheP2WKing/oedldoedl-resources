...
public class BlockArgentoriumGemOre extends Block implements IHasModel
{
	...
	{
		return ItemInit.ITEM_TOUJOURIUM_SHARD;
	}
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.argentorium_gem_ore.tip"),
  			});
  		}
	}
}