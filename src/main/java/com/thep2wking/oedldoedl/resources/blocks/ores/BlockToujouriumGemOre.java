...
public class BlockToujouriumGemOre extends Block implements IHasModel
{
	...
	{
		return ItemInit.ITEM_ARGENTORIUM_SHARD;
	}
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.toujourium_gem_ore.tip"),
  			});
  		}
	}
}