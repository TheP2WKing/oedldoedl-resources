...
public class BlockEnderOre extends Block implements IHasModel
{
    public BlockEnderOre(String name, Material material)
	{
		super(material);
	...
	{
		return ItemInit.ITEM_ENDER_DUST;
	}
	...
	public int getExpDrop(IBlockState state, IBlockAccess world, BlockPos pos, int fortune)
	{
		Random rand = world instanceof World ? ((World)world).rand : new Random();
			if (this.getItemDropped(state, rand, fortune) != Item.getItemFromBlock(this))
				{
					int i = 0;
					if (this == BlockInit.BLOCK_ENDER_ORE)
					{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.ender_ore.tip"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.ender_ore.tip2"),
  			});
  		}
  		...
  		if (CoreConfig.GENEREL.tooltips.originInformation) 
  		{
  			...
  			{
  				TextFormatting.DARK_AQUA+""+TextFormatting.ITALIC+I18n.format("item.oedldoedl.tinypro.origin.tip"),
  			});
  		}
	}
}