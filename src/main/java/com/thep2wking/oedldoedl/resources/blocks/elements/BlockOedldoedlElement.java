package com.thep2wking.oedldoedl.resources.blocks.elements;
...
public class BlockOedldoedlElement extends Block implements IHasModel, TOPInfoProvider
{
    public BlockOedldoedlElement(String name, Material material)
	{
    	super(material);
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.oedldoedl_element_block.tip"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.oedldoedl_element_block.tip2"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.oedldoedl_element_block.tip3"),
  			});
  		}
	}
    ...
    public void addProbeInfo(ProbeMode mode, IProbeInfo probeInfo, EntityPlayer player, World world, IBlockState blockState, IProbeHitData data) 
    {
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			.text(TextFormatting.GRAY+"Where is the infinity, Flofino?");
  		}
    }
}