...
public class BlockSaltpeterOre extends Block implements IHasModel
{
    public BlockSaltpeterOre(String name, Material material)
	{
		super(material);
	...
	{
		return ItemInit.ITEM_SALTPETER_DUST;
	}
	...
	public int getExpDrop(IBlockState state, IBlockAccess world, BlockPos pos, int fortune)
	{
		Random rand = world instanceof World ? ((World)world).rand : new Random();
			if (this.getItemDropped(state, rand, fortune) != Item.getItemFromBlock(this))
				{
					int i = 0;
					if (this == BlockInit.BLOCK_SALTPETER_ORE)
					{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.saltpeter_ore.tip"),
  			});
  		}
