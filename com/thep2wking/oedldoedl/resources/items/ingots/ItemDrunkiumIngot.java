...
public class ItemDrunkiumIngot extends Item implements IHasModel
{
    ...
    public void func_77663_a(ItemStack itemstack, World world, Entity entity, int i, boolean flag)
    {
  		...
  		{
  			((EntityLivingBase) entity).func_70690_d(new PotionEffect(MobEffects.field_76421_d, 200, 3, false, false));
  			((EntityLivingBase) entity).func_70690_d(new PotionEffect(MobEffects.field_76440_q, 200, 5, false, false));
  			((EntityLivingBase) entity).func_70690_d(new PotionEffect(MobEffects.field_76431_k, 200, 5, false, false));
  		}
    }
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.drunkium_ingot.tip"),
  			});
  		}
  		...
  		if (CoreConst.POTION_INFORMATION && CoreConst.POTION_EFFECTS) 
  		{
  			TooltipControlEffectInfo.addTooltipText(tooltip, new String[] 
  			{
  				...
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.func_135052_a("item.oedldoedl.drunkium_ingot.effects.tip"),
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.func_135052_a("item.oedldoedl.drunkium_ingot.effects.tip2"),
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.func_135052_a("item.oedldoedl.drunkium_ingot.effects.tip3"),
  			});
  		}
	}
}