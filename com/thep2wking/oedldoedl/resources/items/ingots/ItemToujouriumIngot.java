...
public class ItemToujouriumIngot extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemToujouriumIngot(String name) 
	{
	...
	public void registerModels()
	{
		...
		{
			ModelResourceLocation toujourium_ingot = new ModelResourceLocation("oedldoedlresources:toujourium_ingot");
			ModelLoader.registerItemVariants(this, toujourium_ingot);
			IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.func_82594_a(toujourium_ingot));
			ModelRegistryHelper.register(toujourium_ingot, wrappedModel);
			ModelLoader.setCustomMeshDefinition(this, stack -> toujourium_ingot);
		}
		else
		{
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.WHITE+I18n.func_135052_a("item.oedldoedl.toujourium_ingot.tip"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.toujourium_ingot.tip2"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.toujourium_ingot.tip3"),
  				TextFormatting.DARK_GREEN+I18n.func_135052_a("core.oedldoedl.stats.tip")+" "+
  				TextFormatting.WHITE+TextFormatting.ITALIC +I18n.func_135052_a("item.oedldoedl.toujourium_ingot.tip4"),
  			});
  		}
	}
}