...
public class ItemGremoriumIngot extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemGremoriumIngot(String name) 
	{
	...
	public void registerModels()
	{
		...
		{
			ModelResourceLocation gremorium_ingot = new ModelResourceLocation("oedldoedlresources:gremorium_ingot");
			ModelLoader.registerItemVariants(this, gremorium_ingot);
			IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.func_82594_a(gremorium_ingot));
			ModelRegistryHelper.register(gremorium_ingot, wrappedModel);
			ModelLoader.setCustomMeshDefinition(this, stack -> gremorium_ingot);
		}
		else
		{
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.DARK_RED+I18n.func_135052_a("item.oedldoedl.gremorium_ingot.tip"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.gremorium_ingot.tip2"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.gremorium_ingot.tip3"),
  				TextFormatting.DARK_GREEN+I18n.func_135052_a("core.oedldoedl.stats.tip")+" "+
  				TextFormatting.DARK_RED+TextFormatting.ITALIC +I18n.func_135052_a("item.oedldoedl.gremorium_ingot.tip4"),
  			});
  		}
	}
}