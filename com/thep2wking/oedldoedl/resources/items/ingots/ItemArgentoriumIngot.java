...
public class ItemArgentoriumIngot extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemArgentoriumIngot(String name) 
	{
	...
	public void registerModels()
	{
		...
		{
			ModelResourceLocation argentorium_ingot = new ModelResourceLocation("oedldoedlresources:argentorium_ingot");
			ModelLoader.registerItemVariants(this, argentorium_ingot);
        	IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.func_82594_a(argentorium_ingot));
        	ModelRegistryHelper.register(argentorium_ingot, wrappedModel);
        	ModelLoader.setCustomMeshDefinition(this, stack -> argentorium_ingot);
		}
		else
		{
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.YELLOW+I18n.func_135052_a("item.oedldoedl.argentorium_ingot.tip"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.argentorium_ingot.tip2"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.argentorium_ingot.tip3"),
  				TextFormatting.DARK_GREEN+I18n.func_135052_a("core.oedldoedl.stats.tip")+" "+
  				TextFormatting.YELLOW+TextFormatting.ITALIC +I18n.func_135052_a("item.oedldoedl.argentorium_ingot.tip4"),
  			});
  		}
	}
}