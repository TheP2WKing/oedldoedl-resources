...
public class ItemSadistiumIngot extends Item implements IHasModel
{
    ...
    public void func_77663_a(ItemStack itemstack, World world, Entity entity, int i, boolean flag)
    {
  		if (CoreConst.POTION_EFFECTS) 
  		{
  			...
  			((EntityLivingBase) entity).func_70690_d(new PotionEffect(MobEffects.field_76419_f, 200, 4, false, false));
        	((EntityLivingBase) entity).func_70690_d(new PotionEffect(MobEffects.field_189112_A, 200, 4, false, false));
        	((EntityLivingBase) entity).func_70690_d(new PotionEffect(MobEffects.field_76437_t, 200, 3, false, false));
  		}
    }
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.sadistium_ingot.tip"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.sadistium_ingot.tip2"),
  			});
  		}
  		...
  		if (CoreConst.POTION_INFORMATION && CoreConst.POTION_EFFECTS) 
  		{
  			TooltipControlEffectInfo.addTooltipText(tooltip, new String[] 
  			{
  				...
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.func_135052_a("item.oedldoedl.sadistium_ingot.effects.tip"),
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.func_135052_a("item.oedldoedl.sadistium_ingot.effects.tip2"),
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.func_135052_a("item.oedldoedl.sadistium_ingot.effects.tip3"),
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.func_135052_a("item.oedldoedl.sadistium_ingot.effects.tip4"),
  			});
  		}
	}
}