...
public class ItemHimejimariumIngot extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	...
	public void registerModels()
	{
		if (CoreConst.CCL_TEXTURES)
		{
			...
			IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.func_82594_a(himejimarium_ingot));
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.DARK_BLUE+I18n.func_135052_a("item.oedldoedl.himejimarium_ingot.tip"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.himejimarium_ingot.tip2"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.himejimarium_ingot.tip3"),
  				TextFormatting.DARK_GREEN+I18n.func_135052_a("core.oedldoedl.stats.tip")+" "+
  				TextFormatting.DARK_BLUE+TextFormatting.ITALIC +I18n.func_135052_a("item.oedldoedl.himejimarium_ingot.tip4"),
  			});
  		}
	}
}