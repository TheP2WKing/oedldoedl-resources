...
public class ItemQuartariumIngot extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemQuartariumIngot(String name) 
	{
	...
	public void registerModels()
	{
		...
		{
			ModelResourceLocation quartarium_ingot = new ModelResourceLocation("oedldoedlresources:quartarium_ingot");
			ModelLoader.registerItemVariants(this, quartarium_ingot);
			IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.func_82594_a(quartarium_ingot));
			ModelRegistryHelper.register(quartarium_ingot, wrappedModel);
			ModelLoader.setCustomMeshDefinition(this, stack -> quartarium_ingot);
		}
		else
		{
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.BLUE+I18n.func_135052_a("item.oedldoedl.quartarium_ingot.tip"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.quartarium_ingot.tip2"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.quartarium_ingot.tip3"),
  				TextFormatting.DARK_GREEN+I18n.func_135052_a("core.oedldoedl.stats.tip")+" "+
  				TextFormatting.BLUE+TextFormatting.ITALIC +I18n.func_135052_a("item.oedldoedl.quartarium_ingot.tip4"),
  			});
  		}
	}
}