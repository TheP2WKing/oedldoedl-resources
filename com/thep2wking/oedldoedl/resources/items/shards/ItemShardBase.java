...
public class ItemShardBase extends Item implements IHasModel
{
	public ItemShardBase(String name) 
	{
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.shard_base.tip"),
  			});
  		}
	}
}