...
public class ItemGremoriumGem extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemGremoriumGem(String name) 
	{
	...
	public void registerModels()
	{
		...
		{
			ModelResourceLocation gremorium_gem = new ModelResourceLocation("oedldoedlresources:gremorium_gem");
			ModelLoader.registerItemVariants(this, gremorium_gem);
			IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.func_82594_a(gremorium_gem));
			ModelRegistryHelper.register(gremorium_gem, wrappedModel);
			ModelLoader.setCustomMeshDefinition(this, stack -> gremorium_gem);
		}
		else
		{
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.DARK_RED+I18n.func_135052_a("item.oedldoedl.gremorium_gem.tip"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.gremorium_gem.tip2"),
  				TextFormatting.DARK_GREEN+I18n.func_135052_a("core.oedldoedl.stats.tip")+" "+
  				TextFormatting.DARK_RED+TextFormatting.ITALIC +I18n.func_135052_a("item.oedldoedl.gremorium_gem.tip3"),
  			});
  		}
	}
}