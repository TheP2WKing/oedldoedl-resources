...
public class ItemQuartariumGem extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemQuartariumGem(String name) 
	{
	...
	public void registerModels()
	{
		...
		{
			ModelResourceLocation quartarium_gem = new ModelResourceLocation("oedldoedlresources:quartarium_gem");
			ModelLoader.registerItemVariants(this, quartarium_gem);
			IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.func_82594_a(quartarium_gem));
			ModelRegistryHelper.register(quartarium_gem, wrappedModel);
			ModelLoader.setCustomMeshDefinition(this, stack -> quartarium_gem);
		}
		else
		{
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.BLUE+I18n.func_135052_a("item.oedldoedl.quartarium_gem.tip"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.quartarium_gem.tip2"),
  				TextFormatting.DARK_GREEN+I18n.func_135052_a("core.oedldoedl.stats.tip")+" "+
  				TextFormatting.BLUE+TextFormatting.ITALIC +I18n.func_135052_a("item.oedldoedl.quartarium_gem.tip3"),
  			});
  		}
	}
}