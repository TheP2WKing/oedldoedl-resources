...
public class ItemHimejimariumGem extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemHimejimariumGem(String name) 
	{
	...
	public void registerModels()
	{
		...
		{
			ModelResourceLocation himejimarium_gem = new ModelResourceLocation("oedldoedlresources:himejimarium_gem");
			ModelLoader.registerItemVariants(this, himejimarium_gem);
			IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.func_82594_a(himejimarium_gem));
        	ModelRegistryHelper.register(himejimarium_gem, wrappedModel);
        	ModelLoader.setCustomMeshDefinition(this, stack -> himejimarium_gem);
		}
		else
		{
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.DARK_BLUE+I18n.func_135052_a("item.oedldoedl.himejimarium_gem.tip"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.himejimarium_gem.tip2"),
  				TextFormatting.DARK_GREEN+I18n.func_135052_a("core.oedldoedl.stats.tip")+" "+
  				TextFormatting.DARK_BLUE+TextFormatting.ITALIC +I18n.func_135052_a("item.oedldoedl.himejimarium_gem.tip3"),
  			});
  		}
	}
}