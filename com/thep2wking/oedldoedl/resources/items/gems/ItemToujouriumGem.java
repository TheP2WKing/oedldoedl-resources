...
public class ItemToujouriumGem extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemToujouriumGem(String name) 
	{
	...
	public void registerModels()
	{
		...
		{
			ModelResourceLocation toujourium_gem = new ModelResourceLocation("oedldoedlresources:toujourium_gem");
			ModelLoader.registerItemVariants(this, toujourium_gem);
			IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.func_82594_a(toujourium_gem));
			ModelRegistryHelper.register(toujourium_gem, wrappedModel);
			ModelLoader.setCustomMeshDefinition(this, stack -> toujourium_gem);
		}
		else
		{
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.WHITE+I18n.func_135052_a("item.oedldoedl.toujourium_gem.tip"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.toujourium_gem.tip2"),
  				TextFormatting.DARK_GREEN+I18n.func_135052_a("core.oedldoedl.stats.tip")+" "+
  				TextFormatting.WHITE+TextFormatting.ITALIC +I18n.func_135052_a("item.oedldoedl.toujourium_gem.tip3"),
  			});
  		}
	}
}