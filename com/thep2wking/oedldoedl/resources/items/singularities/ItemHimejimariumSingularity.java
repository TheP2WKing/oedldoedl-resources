...
public class ItemHimejimariumSingularity extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	...
	public void registerModels()
	{
		if (CoreConst.CCL_TEXTURES)
		{
			...
			IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.func_82594_a(himejimarium_singularity));
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.himejimarium_singularity.tip"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.himejimarium_singularity.tip2"),
  			});
  		}
	}
}