...
public class ItemArgentoriumSingularity extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemArgentoriumSingularity(String name) 
	{
	...
	public void registerModels()
	{
		...
		{
			ModelResourceLocation argentorium_singularity = new ModelResourceLocation("oedldoedlresources:argentorium_singularity");
			ModelLoader.registerItemVariants(this, argentorium_singularity);
			IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.func_82594_a(argentorium_singularity));
			ModelRegistryHelper.register(argentorium_singularity, wrappedModel);
			ModelLoader.setCustomMeshDefinition(this, stack -> argentorium_singularity);
		}
		else
		{
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.argentorium_singularity.tip"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.argentorium_singularity.tip2"),
  			});
  		}
	}
}