...
public class ItemGremoriumSingularity extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemGremoriumSingularity(String name) 
	{
	...
	public void registerModels()
	{
		...
		{
			ModelResourceLocation gremorium_singularity = new ModelResourceLocation("oedldoedlresources:gremorium_singularity");
			ModelLoader.registerItemVariants(this, gremorium_singularity);
			IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.func_82594_a(gremorium_singularity));
			ModelRegistryHelper.register(gremorium_singularity, wrappedModel);
			ModelLoader.setCustomMeshDefinition(this, stack -> gremorium_singularity);
		}
		else
		{
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.gremorium_singularity.tip"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.gremorium_singularity.tip2"),
  			});
  		}
	}
}