...
public class ItemQuartariumSingularity extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemQuartariumSingularity(String name) 
	{
	...
	public void registerModels()
	{
		...
		{
			ModelResourceLocation quartarium_singularity = new ModelResourceLocation("oedldoedlresources:quartarium_singularity");
			ModelLoader.registerItemVariants(this, quartarium_singularity);
			IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.func_82594_a(quartarium_singularity));
        	ModelRegistryHelper.register(quartarium_singularity, wrappedModel);
        	ModelLoader.setCustomMeshDefinition(this, stack -> quartarium_singularity);
		}
		else
		{
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.quartarium_singularity.tip"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.quartarium_singularity.tip2"),
  			});
  		}
	}
}