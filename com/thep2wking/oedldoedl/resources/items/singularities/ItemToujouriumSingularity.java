...
public class ItemToujouriumSingularity extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemToujouriumSingularity(String name) 
	{
	...
	public void registerModels()
	{
		...
		{
			ModelResourceLocation toujourium_singularity = new ModelResourceLocation("oedldoedlresources:toujourium_singularity");
			ModelLoader.registerItemVariants(this, toujourium_singularity);
			IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.func_82594_a(toujourium_singularity));
			ModelRegistryHelper.register(toujourium_singularity, wrappedModel);
			ModelLoader.setCustomMeshDefinition(this, stack -> toujourium_singularity);
		}
		else
		{
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.toujourium_singularity.tip"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.toujourium_singularity.tip2"),
  			});
  		}
	}
}