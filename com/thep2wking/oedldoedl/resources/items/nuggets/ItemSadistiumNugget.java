...
public class ItemSadistiumNugget extends Item implements IHasModel
{
    ...
    public void func_77663_a(ItemStack itemstack, World world, Entity entity, int i, boolean flag)
    {
  		...
  		{
  			((EntityLivingBase) entity).func_70690_d(new PotionEffect(MobEffects.field_188423_x, 10, 0, false, false));
  			((EntityLivingBase) entity).func_70690_d(new PotionEffect(MobEffects.field_76419_f, 100, 2, false, false));
  			((EntityLivingBase) entity).func_70690_d(new PotionEffect(MobEffects.field_189112_A, 100, 2, false, false));
  			((EntityLivingBase) entity).func_70690_d(new PotionEffect(MobEffects.field_76437_t, 100, 1, false, false));
  		}
    }
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.sadistium_nugget.tip"),
  			});
  		}
  		...
  		if (CoreConst.POTION_INFORMATION && CoreConst.POTION_EFFECTS) 
  		{
  			TooltipControlEffectInfo.addTooltipText(tooltip, new String[] 
  			{
  				...
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.func_135052_a("item.oedldoedl.sadistium_nugget.effects.tip"),
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.func_135052_a("item.oedldoedl.sadistium_nugget.effects.tip2"),
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.func_135052_a("item.oedldoedl.sadistium_nugget.effects.tip3"),
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.func_135052_a("item.oedldoedl.sadistium_nugget.effects.tip4"),
  			});
  		}
	}
}