...
public class ItemArgentoriumNugget extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemArgentoriumNugget(String name) 
	{
	...
	{
        ModelResourceLocation argentorium_nugget = new ModelResourceLocation("oedldoedlresources:argentorium_nugget");
        ModelLoader.registerItemVariants(this, argentorium_nugget);
        IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.func_82594_a(argentorium_nugget));
        ModelRegistryHelper.register(argentorium_nugget, wrappedModel);
        ModelLoader.setCustomMeshDefinition(this, stack -> argentorium_nugget);
	}
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.argentorium_nugget.tip"),
  			});
  		}
	}
}