...
public class ItemGremoriumNugget extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemGremoriumNugget(String name) 
	{
	...
	{
        ModelResourceLocation gremorium_nugget = new ModelResourceLocation("oedldoedlresources:gremorium_nugget");
        ModelLoader.registerItemVariants(this, gremorium_nugget);
        IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.func_82594_a(gremorium_nugget));
        ModelRegistryHelper.register(gremorium_nugget, wrappedModel);
        ModelLoader.setCustomMeshDefinition(this, stack -> gremorium_nugget);
	}
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.gremorium_nugget.tip"),
  			});
  		}
	}
}