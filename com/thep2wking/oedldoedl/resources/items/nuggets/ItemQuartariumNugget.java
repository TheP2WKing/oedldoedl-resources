...
public class ItemQuartariumNugget extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemQuartariumNugget(String name) 
	{
	...
	{
        ModelResourceLocation quartarium_nugget = new ModelResourceLocation("oedldoedlresources:quartarium_nugget");
        ModelLoader.registerItemVariants(this, quartarium_nugget);
        IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.func_82594_a(quartarium_nugget));
        ModelRegistryHelper.register(quartarium_nugget, wrappedModel);
        ModelLoader.setCustomMeshDefinition(this, stack -> quartarium_nugget);
	}
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.quartarium_nugget.tip"),
  			});
  		}
	}
}