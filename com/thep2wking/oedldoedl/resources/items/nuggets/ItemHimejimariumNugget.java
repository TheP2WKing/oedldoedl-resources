...
public class ItemHimejimariumNugget extends Item implements IHasModel, IHaloRenderItem, IModelRegister
{
	public ItemHimejimariumNugget(String name) 
	{
	...
	{
        ModelResourceLocation himejimarium_nugget = new ModelResourceLocation("oedldoedlresources:himejimarium_nugget");
        ModelLoader.registerItemVariants(this, himejimarium_nugget);
        IBakedModel wrappedModel = new HaloRenderItem(TransformUtils.DEFAULT_ITEM, modelRegistry -> modelRegistry.func_82594_a(himejimarium_nugget));
        ModelRegistryHelper.register(himejimarium_nugget, wrappedModel);
        ModelLoader.setCustomMeshDefinition(this, stack -> himejimarium_nugget);
	}
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.himejimarium_nugget.tip"),
  			});
  		}
	}
}