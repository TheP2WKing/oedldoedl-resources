...
public class ItemBedrockiumNugget extends Item implements IHasModel
{
    ...
    public void func_77663_a(ItemStack itemstack, World world, Entity entity, int i, boolean flag)
    {
  		...
  		{
  			((EntityLivingBase) entity).func_70690_d(new PotionEffect(MobEffects.field_76421_d, 10, 3, false, false));
  			((EntityLivingBase) entity).func_70690_d(new PotionEffect(MobEffects.field_76438_s, 100, 0, false, false));
  		}
    }
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.bedrockium_nugget.tip"),
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.bedrockium_nugget.tip2"),
  			});
  		}
  		...
  		if (CoreConst.POTION_INFORMATION && CoreConst.POTION_EFFECTS) 
  		{
  			TooltipControlEffectInfo.addTooltipText(tooltip, new String[] 
  			{
  				...
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.func_135052_a("item.oedldoedl.bedrockium_nugget.effects.tip"),
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.func_135052_a("item.oedldoedl.bedrockium_nugget.effects.tip2"),
  			});
  		}
	}
}