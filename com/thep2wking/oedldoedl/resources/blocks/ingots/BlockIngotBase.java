...
public class BlockIngotBase extends Block implements IHasModel, TOPInfoProvider
{
    public BlockIngotBase(String name, Material material)
	{
    	super(material);
	...
	public void func_190948_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.ingot_base_block.tip"),
  			});
  		}
	}
