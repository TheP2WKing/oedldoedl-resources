...
public class BlockInfinityStar extends Block implements IHasModel, TOPInfoProvider
{
    public BlockInfinityStar(String name, Material material)
	{
		super(material);
	...
	public void func_190948_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.infinity_star_block.tip"),
  			});
  		}
	}
    ...
    public void addProbeInfo(ProbeMode mode, IProbeInfo probeInfo, EntityPlayer player, World world, IBlockState blockState, IProbeHitData data) 
    {
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			.text(TextFormatting.GREEN+"Looks not really ugly, right?");
  		}
    }
}