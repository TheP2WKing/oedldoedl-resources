...
public class BlockStarBase extends Block implements IHasModel, TOPInfoProvider
{
    public BlockStarBase(String name, Material material)
	{
    	super(material);
	...
	public void func_190948_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.star_base_block.tip"),
  			});
  		}
	}
