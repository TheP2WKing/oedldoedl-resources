...
public class BlockGremoriumGemOre extends Block implements IHasModel, TOPInfoProvider
{
    public BlockGremoriumGemOre(String name, Material material)
	{
		super(material);
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune)
	{
		...
		{
			drops.add(new ItemStack(ItemInit.ITEM_GREMORIUM_GEM, 1));
		}
		return drops;
	}
	...
	public void func_190948_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.gremorium_gem_ore.tip"),
  				TextFormatting.RED+I18n.func_135052_a("item.oedldoedl.gremorium_gem_ore.tip2"),
  			});
  		}
	}
    ...
    {
  		if (CoreConst.ITEM_INFORMATION && ResourcesConst.GREMORIUM_GEM_ORE) 
  		{
  			probeInfo.horizontal(probeInfo.defaultLayoutStyle().alignment(ElementAlignment.ALIGN_CENTER))
  			.text(TextFormatting.RED+"1 in 100 Chance --> ")
  			.item(new ItemStack(Item.func_111206_d("oedldoedlresources:gremorium_gem")));
  		}
    }
}